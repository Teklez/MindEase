  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 py-12 bg-slate-50/80">
      <div className="w-full max-w-md">
        <h1 className="text-2xl font-semibold text-slate-800 text-center">Create your account</h1>
        <p className="mt-1 text-sm text-slate-600 text-center">Join MindEase and take a step toward calmer days.</p>
